...
def main():
  ...
  # set to true if want to plot images, features etc.
  verbose = False
  ...
  for (r,t) in possible_relative_poses:
      ...
      e_im1.SetPose(r, t) 
      e_im2.SetPose(r1, t1) # identity rotation, no translation -> assumed origin
  ...
  e_im1.SetPose(r, t) 
  e_im2.SetPose(r1, t1)
  # order: which one to identity? => Confused!!!!! first one r,t, second one identity
